...
def parse_args():
    ...
    parser.add_argument('--chest_x_ray_path', default='./data/mimic-cxr/image_384/', help="Directory where chest x-ray image data is stored. This should point to the files folder from the MIMIC chest x-ray dataset.")
